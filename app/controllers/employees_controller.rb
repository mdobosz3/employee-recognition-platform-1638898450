...
class EmployeesController < ApplicationController
    ...
    def update
        ...
        if current_employee.first_name == 'default' || current_employee.last_name == 'default' || current_employee.first_name.nil? || current_employee.last_name.nil?
    ...
    def check_employee
      redirect_to root_path, notice: 'You are not authorized to edit this data.' unless current_employee.first_name == 'default' && current_employee.last_name == 'default'    
    end

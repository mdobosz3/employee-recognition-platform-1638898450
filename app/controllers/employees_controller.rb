...
class EmployeesController < ApplicationController
    ...
    if current_employee.first_name.nil? || current_employee.last_name.nil?
    ...
    def check_employee
      redirect_to root_path, notice: 'You are not authorized to edit this data.' unless current_employee.first_name.nil? && current_employee.last_name.nil?
    end
